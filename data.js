...
// ground/capacity/seated below were entered by hand from Wikipedia (2025–26 NIFL
// Premiership season page, retrieved 23 July 2026) — scripts/fetch-wikidata.js couldn't
// reach Wikidata from the sandbox that built it (see PR #14). lat/lon/founded/website stay
// null until that script runs somewhere with real internet access. NOTE: re-running
// scripts/fetch-wikidata.js replaces this whole block, so it will overwrite these
// hand-entered values too — merge them back in by hand afterwards, or extend the script to
// preserve already-set fields, before running it again.
...
export const CLUB_META = {
  LAR: {
    ...
    founded: null,
    website: null,
    source: "Wikipedia, 2025–26 NIFL Premiership season page, retrieved 23 July 2026",
  },
  COL: {
  ...
  LIM: {
    ...
    founded: null,
    website: null,
    source: "Wikipedia, 2025–26 NIFL Premiership season page, retrieved 23 July 2026 (capacity unconfirmed)",
  },
};
// === CLUB_META END ===
