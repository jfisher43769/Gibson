...
export const PLAYERS = [
  { id: 1, name: "Pat Hoban", club: "GLE", pos: "ST", num: "", rating: 8.3, goals: 25, assists: 2, xg: 21.8, xa: 2.4, per90: { shots: 3.8, keyPasses: 1.0, dribbles: 0.6, tackles: 0.4 }, radar: [95, 52, 56, 46, 32, 84], form: [8.4, 7.6, 9.1, 8.0, 8.8, 7.5], shots: [{x:88,y:46,xg:.72,g:1},{x:84,y:54,xg:.35,g:1},{x:90,y:50,xg:.65,g:1},{x:79,y:42,xg:.14,g:0},{x:86,y:58,xg:.41,g:1},{x:92,y:48,xg:.78,g:0}] },
  { id: 2, name: "Matthew Fitzpatrick", club: "BAN", pos: "ST", num: "", rating: 8.0, goals: 17, assists: 6, xg: 14.6, xa: 4.9, per90: { shots: 3.1, keyPasses: 1.6, dribbles: 0.9, tackles: 0.6 }, radar: [86, 68, 64, 56, 38, 82], form: [7.8, 8.3, 7.5, 8.6, 7.9, 8.1], shots: [{x:85,y:50,xg:.48,g:1},{x:80,y:44,xg:.22,g:1},{x:88,y:56,xg:.60,g:0},{x:76,y:52,xg:.12,g:0},{x:87,y:47,xg:.52,g:1}] },
  { id: 3, name: "Fraser Bryden", club: "CRU", pos: "ST", num: "", rating: 7.8, goals: 18, assists: 0, xg: 15.2, xa: 1.1, per90: { shots: 3.4, keyPasses: 0.8, dribbles: 1.2, tackles: 0.4 }, radar: [88, 46, 54, 62, 30, 80], form: [7.6, 8.2, 7.1, 8.4, 7.8, 7.3], shots: [{x:86,y:48,xg:.55,g:1},{x:82,y:56,xg:.30,g:1},{x:90,y:52,xg:.70,g:0},{x:78,y:44,xg:.15,g:1}] },
  { id: 4, name: "Joel Cooper", club: "COL", pos: "LW", num: "", rating: 7.9, goals: 16, assists: 3, xg: 13.4, xa: 3.2, per90: { shots: 2.7, keyPasses: 2.2, dribbles: 2.5, tackles: 0.7 }, radar: [78, 76, 74, 88, 36, 68], form: [7.9, 8.2, 7.4, 8.5, 7.7, 8.0], shots: [{x:80,y:62,xg:.28,g:1},{x:84,y:56,xg:.42,g:0},{x:73,y:60,xg:.09,g:0},{x:86,y:50,xg:.51,g:1}] },
  { id: 5, name: "Eamon Fyfe", club: "POR", pos: "ST", num: "", rating: 7.7, goals: 12, assists: 5, xg: 10.1, xa: 4.2, per90: { shots: 2.6, keyPasses: 1.7, dribbles: 1.3, tackles: 0.5 }, radar: [78, 66, 62, 64, 36, 74], form: [7.4, 7.9, 7.2, 8.1, 7.6, 7.8], shots: [{x:83,y:48,xg:.40,g:1},{x:78,y:56,xg:.18,g:0},{x:87,y:52,xg:.56,g:1}] },
  { id: 6, name: "Matthew Shevlin", club: "COL", pos: "ST", num: "", rating: 7.6, goals: 14, assists: 2, xg: 12.0, xa: 2.0, per90: { shots: 2.9, keyPasses: 1.1, dribbles: 1.0, tackles: 0.5 }, radar: [82, 54, 58, 58, 34, 76], form: [7.7, 7.3, 8.1, 7.0, 7.9, 7.5], shots: [{x:84,y:50,xg:.45,g:1},{x:79,y:57,xg:.16,g:0},{x:88,y:53,xg:.62,g:1},{x:81,y:41,xg:.24,g:0}] },
  { id: 7, name: "Danny Gibson", club: "CAR", pos: "ST", num: "", rating: 7.5, goals: 12, assists: 3, xg: 10.4, xa: 2.6, per90: { shots: 2.5, keyPasses: 1.3, dribbles: 1.1, tackles: 0.6 }, radar: [78, 58, 56, 60, 36, 76], form: [7.2, 7.8, 7.4, 7.0, 8.0, 7.6], shots: [{x:82,y:52,xg:.36,g:1},{x:77,y:46,xg:.20,g:1},{x:86,y:55,xg:.50,g:0}] },
  { id: 8, name: "Paul Heatley", club: "CAR", pos: "LW", num: "", rating: 7.3, goals: 10, assists: 3, xg: 8.2, xa: 2.9, per90: { shots: 2.2, keyPasses: 1.8, dribbles: 2.0, tackles: 0.4 }, radar: [70, 68, 66, 82, 30, 58], form: [7.1, 7.6, 7.3, 7.8, 6.9, 7.4], shots: [{x:79,y:60,xg:.24,g:1},{x:84,y:54,xg:.38,g:0},{x:74,y:58,xg:.10,g:1}] },
  { id: 9, name: "Will Patching", club: "COL", pos: "CM", num: "", rating: 7.4, goals: 8, assists: 5, xg: 6.4, xa: 4.6, per90: { shots: 2.0, keyPasses: 2.5, dribbles: 1.4, tackles: 1.5 }, radar: [64, 82, 84, 68, 54, 64], form: [7.5, 7.1, 7.8, 7.3, 7.6, 7.2], shots: [{x:75,y:50,xg:.12,g:0},{x:81,y:46,xg:.28,g:1},{x:71,y:56,xg:.07,g:1}] },
  { id: 10, name: "Peter Campbell", club: "BAN", pos: "LW", num: "", rating: 7.4, goals: 2, assists: 11, xg: 3.1, xa: 8.8, per90: { shots: 1.4, keyPasses: 3.0, dribbles: 2.1, tackles: 0.6 }, radar: [50, 90, 76, 80, 34, 62], form: [7.3, 7.8, 7.1, 7.9, 7.4, 7.6], shots: [{x:76,y:58,xg:.14,g:0},{x:82,y:52,xg:.26,g:1},{x:72,y:62,xg:.06,g:0}] },
  { id: 11, name: "Andy Ryan", club: "LAR", pos: "ST", num: "", rating: 7.2, goals: 11, assists: 1, xg: 9.6, xa: 1.3, per90: { shots: 2.8, keyPasses: 1.0, dribbles: 1.4, tackles: 0.4 }, radar: [80, 52, 60, 70, 28, 74], form: [7.0, 7.6, 6.8, 7.7, 7.9, 7.1], shots: [{x:85,y:50,xg:.50,g:1},{x:80,y:44,xg:.24,g:0},{x:89,y:55,xg:.66,g:1}] },
];
...
export const TRANSFERS = [
  ...
  { id: 3, date: "Jul", player: "McMenamin, Henderson & Doherty", fromExternal: "Triple swoop", to: "COL", status: "done", note: "Coleraine mean business: NI international Conor McMenamin arrives from St Mirren, headlining a treble signing alongside Jay Henderson and Ben Doherty." },
...
export const RECORDS = [
  ...
  { big: "25", label: "Pat Hoban's golden boot", sub: "Top scorer of the 2025/26 season for Glentoran (Transfermarkt; some reports credit 26)" },
