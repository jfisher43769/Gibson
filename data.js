...
export const TRANSFERS = [
  { id: 20, date: "10 Jul", player: "Alfie Gaston", from: "COL", toExternal: "Limavady Utd (season loan)", status: "departure", note: "Back to where he won it: Gaston returns to Limavady on a season loan after playing a key part in their Championship title. Smart move all round — the newly promoted side get a player who knows the club, Coleraine get him first-team minutes." },
...
export const PREDICTOR_GW = {
  ...
  fixtures: [
    { id: "f1", home: { external: "Tre Fiori" }, away: { club: "LAR" }, comp: "UCL Q1 · FT 0–1", result: [0, 1], odds: { home: 12.0, draw: 6.0, away: 1.15 } },
    { id: "f2", home: { club: "GLE" }, away: { external: "RFS" }, comp: "UECL Q1 · FT 1–2", result: [1, 2], odds: { home: 3.6, draw: 3.5, away: 1.95 } },
    { id: "f3", home: { external: "Nõmme Kalju" }, away: { club: "LIN" }, comp: "UECL Q1 · FT 1–0", result: [1, 0], odds: { home: 2.6, draw: 3.3, away: 2.5 } },
  ],
};
...
export const WINDOW = [
  { club: "LAR",
    ...
    outs: [["Andy Ryan", "Hamilton Acad."], ["Kofi Moore", "Linfield"], ["Ryan Nolan", "Linfield"], ["Jordan Hastings", "Carrick Rangers"], ["Josh Kee", "HW Welders"], ["Owen Mahoney", "Ballymena Utd"], ["C. Bolger", "Without club"]] },
  { club: "LIN",
  ...
  { club: "COL",
    ...
    outs: [["J. Glackin", "Dungannon"], ["S. Fallon", "Ballymena Utd"], ["G. Kelly", "Crusaders"], ["A. Tejada", "Moyola Park"], ["Jamie McGonigle", "Sligo Rovers (loan)"], ["Alfie Gaston", "Limavady Utd (loan)"]] },
  { club: "CRU",
  ...
  { club: "BAN",
    ...
    outs: [] },
  { club: "LIM",
    ins: [["A. Jarvis", "Ballymena Utd"], ["S. O'Donnell", "Ballymena Utd"], ["D. Lafferty", "Ballymena Utd"], ["R. Wilson", "HW Welders"], ["O. Duffy", "Strabane AFC"], ["Leon Boyd", "Dungannon"], ["S. McClintock", "Loan return (Strabane)"], ["Alfie Gaston", "Coleraine (loan)"]],
...
const EURO = [
  {
    ...
    note: "FIRST LEG: Larne lead 1-0 — Matthew Lusty striking on the stroke of half-time in San Marino. Job half done ahead of the Windsor Park return. Even defeat overall isn't the end: the loser drops into Conference League Q3.",
  },
  {
