...
export const CLUB_META = {
  ...
  COL: {
    ...
    seated: 1607,
    source: "Wikipedia (ground/capacity/seated); coordinates verified by owner from Google Maps, 29 Jul 2026; founded, website, manager from Wikidata (CC0)",
  },
  GLE: {
  ...
  LIN: {
    ...
    manager: null,
    seated: 18434,
    source: "Wikipedia (ground/capacity/seated); coordinates verified by owner from Google Maps, 29 Jul 2026; founded from Wikidata (CC0)",
  },
  CLI: {
    ...
    lon: -5.94722,
    founded: null,
    website: "https://www.nifootballleague.com/all-clubs/cliftonville-ladies/",
    nickname: null,
    manager: null,
    seated: 3054,
    source: "Wikipedia (ground/capacity/seated); coordinates verified by owner from Google Maps, 29 Jul 2026; website from Wikidata (CC0)",
  },
  DUN: {
