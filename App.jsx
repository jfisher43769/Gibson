...
const TABLE = [
  ...
  { club: "GLE", p: 38, w: 24, d: 8, l: 6, gd: 33, pts: 80, note: "E", form: ["W","W","L","W","D"] },
  { club: "COL", p: 38, w: 23, d: 9, l: 6, gd: 30, pts: 78, note: "E", form: ["W","D","W","W","L"] },
...
/* ================= VIEWS ================= */
function TableView() {
  const noteLabel = { C: "Champions · Gibson Cup", E: "Europe (automatic)", EPO: "Europe (via play-off)", P: "Promoted this season", PO: "Relegation play-off", R: "Relegated" };
  const noteColor = { C: "#3DDC84", E: "#FFB627", EPO: "#5EC8F2", P: "#8FA69B", PO: "#E0A252", R: "#E05252" };
  return (
