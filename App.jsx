...
const TRANSFERS = [
  { id: 1, date: "Reported", player: "Ryan Nolan", from: "LAR", to: "LIN", status: "done", note: "Linfield have secured the centre-back on a permanent deal after his form at Larne." },
  { id: 2, date: "3 Jul", player: "Kevin O'Hara", fromExternal: "Hamilton Academical", to: "LAR", status: "rumour", note: "Larne reportedly closing in on the striker, who turned down a new Hamilton deal and interest from Scottish Championship clubs to try the Irish League." },
  { id: 3, date: "12 May", player: "Sam Taylor", fromExternal: "Tranmere Rovers", to: "LIN", status: "rumour", note: "Winger's Linfield loan from Tranmere ends as Tranmere release him — Linfield are favourites to make the move permanent." },
];
const STATUS_META = {
...
const SUPPORT_TIERS = [
  ...
  {
    id: "season", name: "Season Ticket", price: "£3.50", cadence: "per month",
    ...
    <div style={{ animation: "riseIn 0.4s ease-out" }}>
      ...
      <div style={{ marginTop: 24 }}>
        ...
        {[
          ...
          { v: "v1.2", when: "Pre-season", title: "Fixtures & countdown", desc: "26/27 fixture list, opening-day countdown, and match-by-match form tracking.", status: "planned" },
          ...
          { v: "v2.0", when: "Future", title: "Accounts & Premium", desc: "Sign in, save your club, follow players, and unlock deeper analytics.", status: "planned" },
        ].map((r, i) => (
          <div key={r.v} style={{
