...
import {
  CLUBS, FINAL_PLACINGS, MID_TABLE, PLAYERS, AXES, TRANSFERS, STATUS_META, ROLL_OF_HONOUR, ALL_TIME_TITLES, RECORDS, PREDICTOR_GW, store, KOFI_URL, EURO, CLUB_FIXTURES, SUPPORT_TIERS, BEST_XI, SOCIALS, SEASON_ARCHIVE,
} from "./data.js";
        ...
        {tab === "players" && (
          <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr)", gap: 18 }}>
            ...
            <div style={{ fontSize: 10, color: dim, lineHeight: 1.5, marginTop: -8 }}>
              GIBSON Index ratings are our own model. Hoban's 26-goal golden boot is confirmed; other player
              totals are provisional pending the v1.1 verified stats import.
            </div>
