  ...
  return (
    <div style={{ animation: "riseIn 0.4s ease-out" }}>
      ...
      <div style={{ fontSize: 10, color: dim, marginTop: 8, lineHeight: 1.5 }}>
        Confirmed real results: Larne champions (3rd title), Glentoran runner-up, Coleraine and Linfield also into Europe
        (Linfield via the play-off, beating Dungannon Swifts in the final), Bangor promoted, Crusaders in the relegation
        play-off, Glenavon relegated. Positions 6th–10th and exact points/GD are provisional — correct these once you've
        got the final table in front of you.
      </div>
    </div>
  );
}
