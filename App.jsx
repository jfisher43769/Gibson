...
import {
  CLUBS, FINAL_PLACINGS, MID_TABLE, FULL_TABLE, PLAYERS, AXES, TRANSFERS, STATUS_META, ROLL_OF_HONOUR, ALL_TIME_TITLES, RECORDS, PREDICTOR_GW, store, KOFI_URL, EURO, CLUB_FIXTURES, FIXTURES_2627, POST_SPLIT_DATES, SUPPORT_TIERS, BEST_XI, SOCIALS, SEASON_ARCHIVE, MARKET_VALUES, LEAGUE_FACTS, INJURIES,
} from "./data.js";
        ...
        {tab === "players" && (
          <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr)", gap: 18 }}>
            ...
            <div style={{ fontSize: 10, color: dim, lineHeight: 1.5, marginTop: -8 }}>
              Goals and assists verified via Transfermarkt (25/26 league). GIBSON Index ratings, radar profiles,
              xG and per-90 figures are our own model estimates.
            </div>
